...
public interface HandlingEventService {
     ...
     * @throws se.citerus.dddsample.domain.model.handling.CannotCreateHandlingEventException if a handling event that represents an actual event that's relevant to a cargo we're tracking
